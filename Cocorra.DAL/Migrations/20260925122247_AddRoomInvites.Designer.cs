...
namespace Cocorra.DAL.Migrations
{
    ...
    [Migration("20260925122247_AddRoomInvites")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cocorra.DAL.Models.BlockedDevices", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Cocorra.DAL.Models.Report", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Cocorra.DAL.Models.RoomFeedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("RoomFeedbacks", t =>
                        {
                            t.HasCheckConstraint("CK_RoomFeedbacks_Rating", "[Rating] BETWEEN 1 AND 5");
                        });
                });
            ...
            modelBuilder.Entity("Cocorra.DAL.Models.SupportChat", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Cocorra.DAL.Models.SupportMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SupportChatId", "IsFromAdmin")
                        .HasDatabaseName("IX_SupportMessages_ChatId_IsFromAdmin");

                    b.ToTable("SupportMessages");
                });

            modelBuilder.Entity("Cocorra.DAL.Models.SupportTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Cocorra.DAL.Models.UserBlock", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("BlockedDeviceId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Cocorra.DAL.Models.UserEvent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cocorra.DAL.Models.BlockedDevices", b =>
                {
                    b.HasOne("Cocorra.DAL.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("BlockedDevices")
            ...
            modelBuilder.Entity("Cocorra.DAL.Models.Report", b =>
                {
                    b.HasOne("Cocorra.DAL.Models.Room", "ReportedRoom")
                        .WithMany()
                        .HasForeignKey("ReportedRoomId");

                    b.HasOne("Cocorra.DAL.Models.ApplicationUser", "ReportedUser")
                        .WithMany()
                        .HasForeignKey("ReportedUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Cocorra.DAL.Models.ApplicationUser", "Reporter")
                        .WithMany()
            ...
            modelBuilder.Entity("Cocorra.DAL.Models.SupportMessage", b =>
                {
                    b.HasOne("Cocorra.DAL.Models.SupportChat", "SupportChat")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Cocorra.DAL.Models.UserBlock", b =>
                {
                    b.HasOne("Cocorra.DAL.Models.BlockedDevices", "BlockedDevice")
                        .WithMany("UserBlocks")
                        .HasForeignKey("BlockedDeviceId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Cocorra.DAL.Models.ApplicationUser", "Blocked")
                        .WithMany()
                        .HasForeignKey("BlockedId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Cocorra.DAL.Models.ApplicationUser", "Blocker")
                        .WithMany()
